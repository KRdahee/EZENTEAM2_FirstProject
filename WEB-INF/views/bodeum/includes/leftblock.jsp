...
<script type="text/javascript">
	function go_home(){
		self.location = "/mypage/main";
	}
	function go_point(){
		self.location = "/mypage/point";
	}
	function go_coupon(){
		self.location = "/mypage/coupon";
	}	
	function go_orderlist(){
		self.location = "/mypage/orderlist";
	}
	function go_myinq(){
		self.location = "/mypage/myinq";
	}
	function go_mypage_modify(){
		self.location = "/mypage/mypage_modify";
	}
	function go_mylesson(){
		self.location = "/mypage/mylesson"
	}
	function go_lessonstatus(){
		self.location = "/mypage/lessonstatus"
	}
	function go_reviewlist(){
		self.location = "/mypage/reviewlist"
	}
</script>
</html>