...
<%@ include file="../includes/header.jsp" %>
	...
	<div id="restart_info"></div>
							<div class="rightBlock">
								
																								<div class="lesson-title">
									<h2>내 강의</h2>
								</div>
								<div class="lessonthumList">
									<table>
										<tbody>
																						<tr class="no-data">
												<td colspan="3">
													<img src="../resources/dist/img/no_data_img.png">
													<p class="txt">수강중인 영상 교육이 없습니다.</p>
													<div class="btn">
														<a href="/html/edu_movie/teach/edu_request_list.php" class="whiteBtn">영상 교육 둘러보기</a>
													</div>
												</td>
											</tr>
																																</tbody>
								...
								<div class="lesson-bottom">
									...
									<div class="lesson-box">
										...
										<div class="btn">
											<a href="http://cafe.naver.com/bodeumedu" target="_blank"><img src="../resources/dist/img/cafe-icon.png">보듬 회원 카페 바로가기</a>
										</div>
									</div>
									<div class="lesson-box">
