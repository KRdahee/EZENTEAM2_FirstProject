							...
							<div class="mypage_index">
								<div class="container">
									<div class="row">
										<div class="col-50">
											<div class="mp_box1">
												<div class="user-thumb"><img src="../resources/dist/img/yes.jpg"></div>
												<div class="user-info">
													<div class="name"><span>
														${main.name }</span>님</div>
													<div class="id">(${main.userid })</div>
												</div>
												<div class="infobtn">
												...
												<div class="row">
													<div class="col-50">
														<div class="mp_box2" onclick="go_point()">
															<div class="img">
																<img src="../resources/dist/img/mp_index_icon1.png">
															</div>
															<div class="txt">
																<strong>적립금</strong>
																<div>${main.point }</div>
													...
													<div class="col-50">
														<div class="mp_box2" onclick="go_coupon();">
															<div class="img">
																<img src="../resources/dist/img/mp_index_icon2.png">
															</div>
															<div class="txt">
																<strong>보유쿠폰</strong>
																<div>0</div>
													...
													<div class="col-50">
														<div class="mp_box2 mp_box2-1" onclick="go_orderlist();">
															<div class="img">
																<img src="../resources/dist/img/mp_index_icon3.png">
															</div>
															<div class="txt">
																<strong>주문조회</strong>
															</div>
													...
													<div class="col-50">
														<div class="mp_box2 mp_box2-1" onclick="go_myinq();">
															<div class="img">
																<img src="../resources/dist/img/mp_index_icon4.png">
															</div>
															<div class="txt">
																<strong>1:1문의</strong>
															</div>
...
<script type="text/javascript">
	...
	function go_mypage_modify(){
		self.location = "/bodeum/mypage/bodeum/mypage_modify";
	}
