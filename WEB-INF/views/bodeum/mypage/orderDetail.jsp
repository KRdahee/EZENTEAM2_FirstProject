...
<meta property="og:url"
	content="https://bodeum.co.kr/html/common_ui/mypage/orderDetail.php?trade_gubun=1&amp;idx=446398&amp;enc_data=aWR4PTE2Njk5NSZzdGFydFBhZ2U9Jmxpc3RObz0mdGFibGU9aWRfdHJhZGUmY29kZT0mc2VhcmNoX2l0ZW09JnNlYXJjaF9vcmRlcj0=||">
...
<meta name="twitter:image"
	content="https://www.bodeum.co.kr/html/common/img/linkLogo.jpg">
<link rel="canonical"
	href="https://bodeum.co.kr/html/common_ui/mypage/orderDetail.php?trade_gubun=1&amp;idx=446398&amp;enc_data=aWR4PTE2Njk5NSZzdGFydFBhZ2U9Jmxpc3RObz0mdGFibGU9aWRfdHJhZGUmY29kZT0mc2VhcmNoX2l0ZW09JnNlYXJjaF9vcmRlcj0=||">
...
<script>
	...
	gtag('set', 'dimension2', '2023-02-09 15:53:16');
	gtag('config', 'UA-173956953-1');

	gtag('event', 'IP_dimension', {
		'IP' : '112.148.244.244'
	}, 'Date_dimension', {
		'Date' : '2023-02-09 15:53:16'
	});
</script>
...
<script type="text/javascript" async=""
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/830632214/?random=1675925596458&amp;cv=11&amp;fst=1675925596458&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45be3280&amp;u_w=1536&amp;u_h=864&amp;hn=www.googleadservices.com&amp;frm=0&amp;url=https%3A%2F%2Fbodeum.co.kr%2Fhtml%2Fcommon_ui%2Fmypage%2ForderDetail.php%3Ftrade_gubun%3D1%26idx%3D446398%26enc_data%3DaWR4PTE2Njk5NSZzdGFydFBhZ2U9Jmxpc3RObz0mdGFibGU9aWRfdHJhZGUmY29kZT0mc2VhcmNoX2l0ZW09JnNlYXJjaF9vcmRlcj0%3D%7C%7C&amp;ref=https%3A%2F%2Fbodeum.co.kr%2Fhtml%2Fcommon_ui%2Fmypage%2ForderList.php&amp;tiba=Bodeum&amp;auid=2059486910.1674639085&amp;fledge=1&amp;uaa=x86&amp;uab=64&amp;uafvl=Chromium%3B110.0.5481.77%7CNot%2520A(Brand%3B24.0.0.0%7CGoogle%2520Chrome%3B110.0.5481.77&amp;uamb=0&amp;uap=Windows&amp;uapv=15.0.0&amp;uaw=0&amp;data=event%3Dgtag.config&amp;rfmt=3&amp;fmt=4"></script>
</head>
<body>
					...
					<div class="inner-contents">
						<div class="mypage-section">
							<div class="leftBlock">
								...
								<div class="menu-link">
									<ul>
										<li><a href="../../common_ui/mypage/orderList.php"><i
							...
							<script type="text/javascript">
								...
								function receiptView2(cash_no, ordr_idxx,
									...
									window.open(receiptWin2, "",
											"width=370, height=625");
								}
								/* 가상 계좌 모의입금 페이지 호출 */
								/* 테스트시에만 사용가능 */
								/* 실결제시 해당 스크립트 주석처리 */
							...
							<div class="rightBlock">
										...
										<tr>
											<th colspan="3">
												<div class="order-date">
													2023-02-09
													<!-- ?if($trade_gubun=='2' || $trade_gubun=='3' || $trade_gubun=='4'){?>< ?=$tools->strDateCut($trade_row->trade_money_ok,3);?>< ?} else { ?>< ?=$tools->strDateCut($trade_row->trade_day,3); ?>< ?}? -->
													<span>[주문번호 : EPOPJ1675923901]</span>
												</div>
												<div class="order-btn">
											...
											<tr>
												<td class="prd-info">
													<div class="title-wrap">
														...
														<div class="buy-info">
															<p class="title-txt"></p>
															<div class="mb-5 orderNumber">상품주문번호 :
																${order.ordernum }</div>
															<a
																href="/resources/bodeum.co.kr/html/shop/prd_detail.php?idx=1046">${order.ordered }</a>
															<p></p>
															<div class="option">
																<p>나중에 opt1</p>
															</div>
												...
												<td class="col-price"><span class="label">상품금액</span> <span
													class="price"><strong>${order.orderprice}</strong>원</span></td>
												<td class="col-orderState"><span class="label">상태</span>
													<span><span class="blue">결제완료</span> <br>(2023-02-10
														23:59:59)</span> <!-- 
																								--></td>
											</tr>
										</c:forEach>
									...
									<div class="payLeft">
										<table class="orderList-table paylst-table">
											...
											<tbody>
												...
												<tr>
													<th>임금기한</th>
													<td><span class="blue"> 2023년 02월 10일 23시 59분까지
													</span></td>
												</tr>
											</tbody>
										</table>
								...
								<div class="btn">
									<a href="javascript:history.go(-1);" class="roundBtn whiteBtn">목록으로</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div id="pop1" class="simplePopup popup1" style="display: none;">
				<div id="Inq-popup" class="modal-box">
					<div class="modal-body">
						...
						<p class="txt">
							주문취소/ 반품/ 환불요청은 1:1문의에 취소하기를 <br> 원하시는 내용을 남겨주시면 취소가능 여부를
							확인후 <br> 관리자가 처리 또는 연락드리고 있습니다.
						</p>
						<div class="btn">
	...
	<iframe allow="join-ad-interest-group" data-tagging-id="AW-830632214"
		data-load-time="1675925596473" height="0" width="0"
		style="display: none; visibility: hidden;"
		src="https://td.doubleclick.net/td/rul/830632214?random=1675925596458&amp;cv=11&amp;fst=1675925596458&amp;fmt=3&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45be3280&amp;u_w=1536&amp;u_h=864&amp;hn=www.googleadservices.com&amp;frm=0&amp;url=https%3A%2F%2Fbodeum.co.kr%2Fhtml%2Fcommon_ui%2Fmypage%2ForderDetail.php%3Ftrade_gubun%3D1%26idx%3D446398%26enc_data%3DaWR4PTE2Njk5NSZzdGFydFBhZ2U9Jmxpc3RObz0mdGFibGU9aWRfdHJhZGUmY29kZT0mc2VhcmNoX2l0ZW09JnNlYXJjaF9vcmRlcj0%3D%7C%7C&amp;ref=https%3A%2F%2Fbodeum.co.kr%2Fhtml%2Fcommon_ui%2Fmypage%2ForderList.php&amp;tiba=Bodeum&amp;auid=2059486910.1674639085&amp;fledge=1&amp;uaa=x86&amp;uab=64&amp;uafvl=Chromium%3B110.0.5481.77%7CNot%2520A(Brand%3B24.0.0.0%7CGoogle%2520Chrome%3B110.0.5481.77&amp;uamb=0&amp;uap=Windows&amp;uapv=15.0.0&amp;uaw=0&amp;data=event%3Dgtag.config"></iframe>
	...
	<div id="wp_tg_cts" style="display: none;">
		<script id="wp_tag_script_1675925596503" charset="UTF-8"
			src="https://astg.widerplanet.com/delivery/wpc.php?v=1&amp;ver=4.0&amp;r=1&amp;md=bs&amp;ga=1ht1tnd-15n4u7h-3-1&amp;wp_uid=2-ce5aebea35bf2d597d540bf3826e06b8-s1673928035.793000%7Cwindows_10%7Cchrome-1v1ehwe&amp;ty=Home&amp;ti=41304&amp;device=web&amp;charset=UTF-8&amp;tc=1675925596502&amp;ref=https%3A%2F%2Fbodeum.co.kr%2Fhtml%2Fcommon_ui%2Fmypage%2ForderList.php&amp;loc=https%3A%2F%2Fbodeum.co.kr%2Fhtml%2Fcommon_ui%2Fmypage%2ForderDetail.php%3Ftrade_gubun%3D1%26idx%3D446398%26enc_data%3DaWR4PTE2Njk5NSZzdGFydFBhZ2U9Jmxpc3RObz0mdGFibGU9aWRfdHJhZGUmY29kZT0mc2VhcmNoX2l0ZW09JnNlYXJjaF9vcmRlcj0%3D%7C%7C"></script>
