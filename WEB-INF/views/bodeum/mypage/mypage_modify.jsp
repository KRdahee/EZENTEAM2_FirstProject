...
<title>Insert title here</title>
	<link rel="stylesheet" type="text/css" href="../../../resources/dist/css/common3860.css" />
	<link rel="stylesheet" type="text/css" href="../../../resources/dist/css/slider.css" />
	<link rel="stylesheet" type="text/css" href="../../../resources/dist/css/main.css" />
	<link rel="stylesheet" type="text/css" href="../../../resources/dist/css/slick.css">
	<link rel="stylesheet" type="text/css" href="../../../resources/dist/css/slick-theme.css">
</head>
<body>
					...
					<div class="inner-contents">
						<div class="mypage-section">
							...
							<div class="rightBlock">
								<div class="moidify">
									<form action="profile-modify_exe.php" method="post" name="writeForm" enctype="multipart/form-data">
									...
									<div class="mypage-modifyWrap">
											...
											<div class="loginBoxArea">
												<div class="userInfo">
													...
													<div class="loginInput2 mb-20">
														<input type="password" class="user_pw fullInput mb-5" name="userpw" placeholder="4-10자의 영문, 특수문자, 숫자">
													...
													<div class="gender mb-20">
														<div class="radioArea">
															...
															<input type="radio" name="gender" id="radioTwo" value="Female" > 
													...
													<div class="birth mb-20">
														<div class="srchFilter">
															...
															<select id="select2" class="w100" name="b_day">
															  <option value="${member.b_day }">일 선택</option>
													...
													<div class="number mb-20">
														<div class="srchFilter">
															<select class="w160" name="hp1" id="hp1">
															...
															<span>-</span>
															<input type="text" class="phone onlynum" name="hp2" id="hp2" maxlength="4" placeholder="" value="${member.ph2 }">
															<span>-</span>
															<input type="text" class="phone onlynum" name="hp3" id="hp3" maxlength="4" placeholder="" value="9143">
													...
													<h4>이메일</h4>
														<div>
															<input type="text" class="mail1" name="email" id="email1" value="${member.email1 }" placeholder="이메일 주소">
															<span>@</span>
										...
										<div class="btn">
											<a href="javascript:modifySendit();" class="roundBtn blueBtn">저장하기</a>
