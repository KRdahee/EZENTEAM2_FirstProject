	...
	<div id="wrapper">
		<div class="containerWrap">
			...
			<div class="page-title-menu  education-page-menu">
				<ul>
					<li class="on"><a><div onclick="video()"> 영상 교육</div></a></li>
					<li><a><div onclick="group()"> 그룹 레슨</div></a></li>
					<li><a><div onclick="single()"> 개인 레슨</div></a></li>
				</ul>
			</div>
			<div class="content minH-auto">
						...
						<div class="edu-video-process">
							...
							<div class="tab_container">
								<div id="tab1" class="tab_content" style="display: block;">
									...
									<a href="/html/edu_movie/teach/edu_request_list.php"
								...
								<div id="tab3" class="tab_content" style="display: none;">
									...
									<a href="/html/edu_movie/teach/topics.php" class="roundBtn">교육신청</a>
								</div>
								<!-- #tab3 -->
							</div>
							<!-- .tab_container -->
				...
				<div class="inner-contents edu-video5">
					<div class="section">
											...
											<div class="profile">
												<div class="thumb">
													<div class="ratio4 thumbnail-wrapper">
														<div class="thumbnail">
															<div class="centered">
																<img src="../../../resources/img/reviewThum.png"
																	class="landscape">
															</div>
														</div>
													</div>
