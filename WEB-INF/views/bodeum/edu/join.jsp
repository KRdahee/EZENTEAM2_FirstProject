						...
						<form action="/bodeum/edu/join" method="post" name="writeForm">
								...
								<div class="loginBoxArea">
									...
									<div class="userInfo">
										...
										<div class="number">
											<h4>휴대폰</h4>
											<div class="srchFilter">
												<select id="hp1" class="w160 onlynum" name="hp1">
													<option value="">-</option>
												...
												<input type="text" class="phone onlynum" name="hp2" id="hp2" maxlength="4" placeholder=""> 
												<span>-</span>
												<input type="text" class="phone onlynum" name="hp3" id="hp3" maxlength="4" placeholder="">
											...
											<!-- <div class="certification">
												...
												<a href="javascript:authNumberCheck();" class="roundBtn whiteBtn">인증번호 확인
							...
							<div class="col-50 agreeBoxArea">
								...
								<div class="mail">
									<h4>이메일</h4>
									<div class="mb-10">
										<input type="text" class="mail1" name="email" id="email1" placeholder="이메일 주소" value=""> 
											<span>@</span>
