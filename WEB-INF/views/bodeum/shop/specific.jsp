...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
    ...
    function reviewWinOpen() {
        window.open("product_review.php?goods_data=aWR4PTg2NCZwYXJ0X2lkeD0yOQ==||", "","scrollbars=no, width=484, height=400, top=200, left=200");
    }
    
    // 리뷰수정
    function reviewEditOpen(aa) {
        window.open("product_review_edit.php?review_idx="+aa+"&goods_data=aWR4PTg2NCZwYXJ0X2lkeD0yOQ==||", "","scrollbars=no, width=484, height=400, top=200, left=200");
    }
    
    // 리뷰삭제
    function reviewDel(aa){
        confirm("선택하신 상품평을 삭제하시겠습니까?");
        document.location.href="product_review_del.php?review_idx="+aa+"&goods_data=aWR4PTg2NCZwYXJ0X2lkeD0yOQ==||";
    }
    ...
    function goodsBuySendit(check){
        ...
        if(check==1) { // 장바구니추가
            ...
            var params = "session_cart=aaa";
            $.ajax({
                    type : 'POST',                                    // post 타입 전송
                    url : 'addcart_ajax.php',   // 전송 url
                    data : formData,   // 전송 파라미터
                   success : function(data){          // 콜백 성공 응답시 실행
                       $(".cartPopover").removeClass('blind');
                    },
            ...
            form.action="/html/common_ui/order/order_insert.php?gubun=goods&trade_method=4";
            form.submit();
        } else if(check==3) { // withlist 추가
            form.action="../mypage/my_wish_list.php?wishlist_method=1&goods_data=aWR4PTg2NCZwYXJ0X2lkeD0yOQ==||";
            form.submit();
        }
        ...
        function selectOption(n,m) {
            var form = document.goods_form;
            var index1 =  $("#optionName1 option").index($("#optionName1 option:selected"));
            var index2 =  $("#optionName2 option").index($("#optionName2 option:selected"));
            var index3 =  $("#optionName3 option").index($("#optionName3 option:selected"));
		...
		<div class="content">
					...
					<div class="contents" id="fixed-parent">
						...
						<div id="prdInfoWrap">
							<form method="post" name="goods_form" id="goods_form">
								...
								<input type="hidden" name="goods_idx" id="goods_idx" value="${itemnum.itemnum}">
								<input type="hidden" name="goods_code" value="1635147950">
								<input type="hidden" name="goods_name" value="${itemnum.item}"> 
								<input type="hidden" name="hidden_shop_price" value="${itemnum.itemdisco} "> 
								<input type="hidden" name="hidden_tot_shop_price" value="${itemnum.itemdisco} ">
								<input type="hidden" name="hidden_option_price1" value="0">
								<input type="hidden" name="hidden_option_price2" value="0">
								<input type="hidden" name="hidden_option_price3" value="0">
								<input type="hidden" name="point_js" value="0.01"> <input
									type="hidden" name="goods_point" id="goods_point" value="1">
								<input type="hidden" name="option_check" value="2"> <input
									type="hidden" name="opt1" value=""> <input
									type="hidden" name="opt2" value=""> <input
									type="hidden" name="opt3" value="">
								...
								<div class="prdInfoWrap prdInfoWrapScroll">
									<div class="prdInfo">
										...
										<p class="prd-title">${itemnum.item}</p>
										<dl>
											<dt>판매가</dt>
											<dd class="price">
												<strong class="price"> ${itemnum.itemprice}</strong><span>원</span>
											</dd>
										</dl>
										<dl>
											<dt>할인가</dt>
											<dd class="point">
												<strong> ${itemnum.itemdisco}</strong><span>원</span>
											</dd>
										</dl>
										<dl>
											<dt>적립금</dt>
										...
										<div class="option">
											...
											<div class="srchFilter mb-40">
												...
												<select name="optionName1" id="optionName1"
													onchange="optionSelect('1635147950','1','2',this.value)">
													<option value="0//0" class="disabled2">컬러</option>
													<option value="이지 뽀글이 자켓 크림">${itemnum.opt1}</option>
													<option value="이지 뽀글이 자켓 카키">${itemnum.opt2}</option>
													<option value="이지 뽀글이 자켓 머스터드">${itemnum.opt3}</option>
												</select> 
												
												<input type="hidden" name="option_title2" value="사이즈">
												<div id="option2">
													<select name="optionName2" id="optionName2"
														onchange="selectOption(this.value,'2')">
														<option value="0//0">사이즈</option>
														<option value="소형">${itemnum.opt4}</option>
														<option value="중형">${itemnum.opt5}</option>
														<option value="대형">${itemnum.opt6}</option>
													</select>
												</div>
											</div>
											...
											<div id="cart_list">
												...
												<div class="prd-total">
													<dl>
														<dt>총상품금액</dt>
														<dd>
															<strong class="sale_price" id="money">0</strong><span>원</span>
														</dd>
													</dl>
												</div>
												<!-- //-->
									...
									<div class="btn">
										...
										<a href="javascript:goodsBuySendit(1);" id="cartBtn"
											...
											href="javascript:goodsBuySendit(2);" class="roundBtn blueBtn">결제하기</a>
							...
							<div class="prdDetailExp-1">
									...
									<div>
										<div align="center" style="text-align: center;">
											<div style="text-align: center; line-height: 0;"
												align="center">
												<img
													src="../../../resources/Bodeum_files/1609901863_%2528860%25292021-01-04-%25EC%25A3%25BC%25EB%25AC%25B8%25EC%2584%259C-%25EB%25A7%2588%25EA%25B0%2590-%25EC%2595%2588%25EB%2582%25B4.jpg"
													title="1609901863_%2528860%25292021-01-04-%25EC%25A3%25BC%25EB%25AC%25B8%25EC%2584%259C-%25EB%25A7%2588%25EA%25B0%2590-%25EC%2595%2588%25EB%2582%25B4.jpg">
											</div>
											<div style="text-align: center; line-height: 0;"
												align="center">
										...
										<div align="center" style="text-align: center;">
											<img
												src="../../../resources/Bodeum_files/1623822235_%25EC%25B0%25A9%25EC%259A%25A9%25EC%258B%259C-%25ED%2584%25B0%25EC%25B9%2598-%25EB%25B2%2594%25EC%259C%2584_%25EB%25AA%25A9%25EC%25A4%2584%25EC%25B0%25A9%25EC%259A%25A9.jpg"
												title="1623822235_%25EC%25B0%25A9%25EC%259A%25A9%25EC%258B%259C-%25ED%2584%25B0%25EC%25B9%2598-%25EB%25B2%2594%25EC%259C%2584_%25EB%25AA%25A9%25EC%25A4%2584%25EC%25B0%25A9%25EC%259A%25A9.jpg"><br>
										</div>
										<div align="center" style="text-align: center;">
											<div style="text-align: center; line-height: 0;"
												align="center">
											...
											<div style="text-align: center; line-height: 0;"
												...
												<iframe width="320" height="180"
													src="../../../resources/Bodeum_files/292679939"
										...
										<div align="center" style="text-align: center;">
											<img
												src="../../../resources/Bodeum_files/1644990446_%25EB%25B3%25B4%25EB%2593%25ACPB%2B%25EC%2583%2581%25EB%258B%25A8.jpg"
												title="1644990446_%25EB%25B3%25B4%25EB%2593%25ACPB%2B%25EC%2583%2581%25EB%258B%25A8.jpg"><br
												style="clear: both;"> <img
												src="../../../resources/Bodeum_files/1635148317_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%2585_01.jpg"
												title="1635148317_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%2585_01.jpg"><img
												src="../../../resources/Bodeum_files/1635148334_color-gif.gif"
												title="1635148334_color-gif.gif"><img
												src="../../../resources/Bodeum_files/1635153872_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%2585_03.jpg"
												title="1635153872_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%2585_03.jpg">&nbsp;
										</div>
										<div align="center" style="text-align: center;">
											<div style="text-align: center; line-height: 0;"
												align="center">
												<img
													src="../../../resources/Bodeum_files/1635148361_%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EB%25B2%25A8%25ED%2581%25AC%25EB%25A1%259C-gif.gif"
													title="1635148361_%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EB%25B2%25A8%25ED%2581%25AC%25EB%25A1%259C-gif.gif">
											</div>
											<div style="text-align: center; line-height: 0;"
												align="center">
												<img
													src="../../../resources/Bodeum_files/1635148373_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%2585_05.jpg"
													title="1635148373_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%2585_05.jpg"><img
											...
											<div style="text-align: center; line-height: 0;"
												align="center">
												<img
													src="../../../resources/Bodeum_files/1635153901_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%2585_08.jpg"
													title="1635153901_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%2585_08.jpg"><br
													style="clear: both;"> <br>
											</div>
											<div style="text-align: center; line-height: 0;"
												align="center">
											...
											<div style="text-align: center; line-height: 0;"
												align="center">
												<img
													src="../../../resources/Bodeum_files/1635148440_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%25852_02.jpg"
													title="1635148440_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%25852_02.jpg">
											</div>
											<div style="text-align: center; line-height: 0;"
												align="center">
												<img
													src="../../../resources/Bodeum_files/1635148446_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%25852_03.jpg"
													title="1635148446_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%25852_03.jpg">
											</div>
											<div style="text-align: center; line-height: 0;"
												align="center">
												<img
													src="../../../resources/Bodeum_files/1635148454_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%25852_04.jpg"
													title="1635148454_%2528760%25292021-10-25-%25EC%259D%25B4%25EC%25A7%2580-%25EB%25BD%2580%25EA%25B8%2580%25EC%259D%25B4-%25EC%25B5%259C%25EC%25A2%25852_04.jpg"><img
													src="../../../resources/Bodeum_files/1667805063_2.jpg"
													title="1667805063_2.jpg"><br style="clear: both;">
												<br style="clear: both;"> <img
													src="../../../resources/Bodeum_files/1663635340_%28760%292022-09-20-%EA%B5%AC%EB%A7%A4%ED%8F%89-%EB%A7%88%EC%BC%80%ED%8C%85-%EC%82%AC%EC%9A%A9-%EC%95%88%EB%82%B4.jpg"
													title="1663635340_%28760%292022-09-20-%EA%B5%AC%EB%A7%A4%ED%8F%89-%EB%A7%88%EC%BC%80%ED%8C%85-%EC%82%AC%EC%9A%A9-%EC%95%88%EB%82%B4.jpg">
											</div>
											<div style="text-align: center; line-height: 0;"
												align="center">
												<br>
										...
										<div align="center" style="text-align: center;">
											<img
												src="../../../resources/Bodeum_files/1604020988_%25EC%2583%2581%25EC%2584%25B8%25ED%258E%2598%25EC%259D%25B4%25EC%25A7%2580-%25ED%2595%2598%25EB%258B%25A8%2528750px%2529.jpg"
												title="1604020988_%25EC%2583%2581%25EC%2584%25B8%25ED%258E%2598%25EC%259D%25B4%25EC%25A7%2580-%25ED%2595%2598%25EB%258B%25A8%2528750px%2529.jpg">
										</div>
										<div align="center" style="text-align: center;">
											<br>
										</div>
								...
								<div class="product-service detail-prd-content"
									...
									<div class="serviceBox">
										...
										<div style="text-align: left; line-height: 1.8;" align="left">
										...
										<p style="line-height: 1.8;">
											<span
												...
												style="font-size: 10pt;">1. 구매자의 단순 변심은 상품 수령 후 7일 이내</span></span>
										</p>
										<p style="line-height: 1.8;">
											<span
												style="color: rgb(37, 37, 37); font-family: 나눔고딕, NanumGothic, sans-serif; font-size: 9pt;"><span
								...
								<div class="product-review detail-prd-content" id="review">
									<h4>
										상품후기<span class="count">( ${review.rcnt} )</span>
										<!--
						 			...
						 			<script type="text/javascript">
                                        function goPage(PageNumber) {
                                            $.ajax({
                                                ...
                                                type: 'GET',
                                                data: 'idx=864&PageNumber=' + PageNumber,
										...
										<ul class="reviewAccodion">
											<li class="review-title">
												<div class="txt">												
													...
													<p>
														<span>${review.userid }</span><span>${review.rdates }</span>
													</p>
												</div>
											</li>
											...
											<li class="review-content">
												...
												처음일거 같아서 옷 고르는데 고민이 많았어요! 일단 옷 입을 때 간편했으면 했구, 디자인적으로 제 취향이고
												애기한테 잘 어울려야 했습니다 ㅋㅋㅋㅋ 그러다 몇날며칠을 고민하고 구매했는데 만족도 최상입니다!!! 옷 위로
												하네스를 채워야하는 줄 알았는데 반대여서 너무 신기했어요 ㅋㅋㅋ 진짜 사람들 똑똑해!!! 애기도 입고다닐때
												전혀 거슬려하지 않네요! 보듬숍 짱짱 ????????
											</li>
											<li class="review-title">
												<div class="txt">
            ...
            <a href='?code=&category=보듬숍상품&PageNumber=2&goods_idx=&search_order='>Next</a>		 </p>
								...
								<div class="product-qa detail-prd-content" id="delevery">
									<h4>
										상품Q&A 
										<span class="count"> ${boardnum.cnt}</span>
										<!--버튼 클라스추가-->
									...
									<div class="qaList">
										<ul class="qaAccodion">
											...
											<input type="hidden" name="boardnum" value="board.boardnum ">
												<div class="qa-txt">
													<h5 class="txt ">${boardnum.title}</h5>
													<p>
														<span> ${boardnum.userid}</span>
														<span> ${boardnum.dates} </span>
													</p>
													<div class="state">
														<span class="complete">${boardnum.answerchk}</span>
													</div>
												</div>
											</li>
											<li class="qa-content">
												<div class="qa-q">
													...
													<div class="txt"> ${boardnum.content} </div>
												</div>
												<div class="qa-a">
											...
											<li class="qa-title2"
												...
												<div class="qa-txt">
													<h5 class="txt secret">상품문의 / ${boardnum.title}</h5>
													<p>
														<span> ${boardnum.userid}</span><span> ${boardnum.dates}</span>
													</p>
													<div class="state">
														<span class="complete">${boardnum.answerchk}</span>
													</div>
											...
											<li class="qa-content">
												<div class="qa-q">
													<div class="qa-icon">${boardnum.title}</div>
													<div class="txt">
														${boardnum.content}
													</div>
												</div>
								...
								<div id="layerPopup" class="qaPopup" style="display: none;">
									...
									<div data-hey-body>
										<div class="myQaWritePopup">
											<form action="/bodeum/shop/specific"
												...
												<input type="hidden" name="bbs_data" value=""> <input
													...
													type="hidden" name="userid" value="${boardnum.userid }"> <input
													type="hidden" name="pwd"
													value="a5419b1ffebe8ce53a3e6cd1c1fac86f"> <input
													type="hidden" name="code" value="myInq"> <input
													type="hidden" name="goods_idx" value="864"> <input
													type="hidden" name="goods_name" value="${ itemnum.item}">
												...
												<table class="list-table">
													...
													<tbody>
														...
														<tr>
															<td>
																<h4>이메일</h4> 
																<input type="text" class="w160" name="email" />
																<div class="checkArea mb-10">
																	<input type="checkbox" name="email_check" id="check1" value="1"> 
												...
												<div class="checkArea mb-10 left">
													<input type="checkbox" name="secret" id="check3" value="y">
													<label for="check3" class="check">비밀글로 문의하기</label>
												</div>
												<!--//171031 추가-->
											</form>

											<div class="btn">
												<a href="javascript:;" class="roundBtn whiteBtn" onClick="self.close();">취소</a> <a
													href="javascript:writeSendit();" class="roundBtn blueBtn" >등록</a>
											</div>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
    ...
    function mobRfShop(){
      var sh = new EN();      
      // [상품상세정보]
      sh.setData("sc", "72864144785a57a047771767a11f1982");
      sh.setData("userid", "hunter527");
      sh.setData("pcode", "1635147950");
      sh.setData("pnm", encodeURIComponent(encodeURIComponent("보듬 이지 뽀글이 자켓 강아지 패딩")));
      sh.setData("img", encodeURIComponent(location.protocol + '//' + location.host + "../Bodeum/Bodeum_files/1635147950_IMAGES1.jpg"));   //전체URL(http포함)
      sh.setData("price","59500");
    ...
    wptg_tagscript_vars.push(
        (function () {
            return {
                ...
                , items: [{ i: "864", t: "보듬 이지 뽀글이 자켓 강아지 패딩" }] /* i:<상품 식별번호  (Feed로 제공되는 상품코드와 일치하여야 합니다 .) t:상품명  */
            };
        }));
</script>
